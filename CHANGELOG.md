...
+ Added a single circular mobile menu button that reveals a compact, state-aware Open/Close/Lock action panel with icons when available and outside-tap dismissal.
