...
+ Simplified mobile controls: a 56px circular control now uses menu, lock, and unlock icons when available, with a touch-compatible mobile close header action.
