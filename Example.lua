...
-- Lightweight, draggable HUD for experience-owned status data.
local StatusHUD = HUD.new(Library, {
...
StatusHUD:AddText("Access", {
    Text = "Access",
    Value = "Awaiting key",
})
StatusHUD:AddProgress("Loading", {
    Text = "Session readiness",
    Value = 0.75,
})
StatusHUD:AddCounter("Objectives", {
    Text = "Objectives",
    Value = 0,
})
StatusHUD:AddTimer("DemoTimer", {
    Text = "Demo timer",
    Duration = 90,
})
StatusHUD:AddProgressRing("ProgressRing", {
    Text = "Milestone",
    Value = 0.6,
})
