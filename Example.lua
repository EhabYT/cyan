...
local CreditsButton = HelpGroup:AddButton(I18n:T("settings.credits"), function()
    Window:AddDialog("CyanCredits", {
        Title = I18n:T("settings.credits_title"),
        Description = I18n:T("settings.credits_description"),
        AutoDismiss = true,
        OutsideClickDismiss = true,
        FooterButtons = {
            Close = {
                Title = I18n:T("settings.credits_close"),
                Variant = "Primary",
...
local LocalizedSettingsElements = {
    ...
    { CreditsButton, "settings.credits" },
