...
local I18n = Localization.new({
    ...
    Locales = {
        en = {
            ...
            ["settings.help"] = "Help",
            ["settings.performance"] = "Performance profile",
            ["settings.balanced"] = "Balanced profile",
            ["settings.help_text"] = "Tap CyanLogo to open or close. Hold it for Lock. Drag it to move it. Ctrl+K searches; Ctrl+P opens commands.",
            ["settings.discord_credit"] = "Community & Discord: https://discord.gg/3TdxfzrYwf",
            ["settings.made_by"] = "Made by EB",
            ["settings.credits"] = "Open Credits",
            ["settings.credits_title"] = "Cyan Credits",
            ["settings.credits_description"] = "Made by EB\n\nCommunity & Discord:\nhttps://discord.gg/3TdxfzrYwf",
            ["settings.credits_close"] = "Close",
            ["settings.reset_mobile_position"] = "Reset mobile action position",
            ["tabs.key"] = "Key System",
            ["tabs.settings"] = "UI Settings",
            ["tabs.credits"] = "Credits",
            ["credits.group"] = "Cyan Credits",
        ...
        de = {
            ...
            ["settings.quick_actions"] = "Schnellaktionen",
            ["settings.help"] = "Hilfe",
            ["settings.performance"] = "Performance-Profil",
            ["settings.balanced"] = "Balanced-Profil",
            ["settings.help_text"] = "Tippe auf CyanLogo zum Öffnen oder Schließen. Halten zeigt Lock. Ziehe es zum Verschieben. Ctrl+K sucht; Ctrl+P öffnet Befehle.",
            ["settings.discord_credit"] = "Community & Discord: https://discord.gg/3TdxfzrYwf",
            ["settings.made_by"] = "Made by EB",
            ["settings.credits"] = "Open Credits",
            ["settings.credits_title"] = "Cyan Credits",
        ...
        ar = {
            ...
            ["settings.balanced"] = "وضع متوازن",
            ["settings.help_text"] = "اضغط CyanLogo لفتح أو إغلاق القائمة. اضغط مطولًا لإظهار القفل. اسحبه لتغيير موضعه. Ctrl+K للبحث وCtrl+P للأوامر.",
            ["settings.discord_credit"] = "المجتمع وDiscord: https://discord.gg/3TdxfzrYwf",
            ["settings.made_by"] = "صنع بواسطة EB",
            ["settings.credits"] = "فتح الاعتمادات",
            ["settings.credits_title"] = "اعتمادات سيان",
            ["settings.credits_description"] = "صنع بواسطة EB\n\nالمجتمع وDiscord:\nhttps://discord.gg/3TdxfzrYwf",
            ["settings.credits_close"] = "إغلاق",
            ["settings.reset_mobile_position"] = "إعادة موضع زر الموبايل",
            ["tabs.key"] = "نظام المفاتيح",
            ["tabs.settings"] = "إعدادات الواجهة",
            ["tabs.credits"] = "الاعتمادات",
            ["credits.group"] = "اعتمادات سيان",
...
local Tabs = {
    ...
    Credits = Window:AddTab(I18n:T("tabs.credits"), "badge-check"),
...
local QuickActionsGroup = Tabs["UI Settings"]:AddLeftGroupbox(I18n:T("settings.quick_actions"), "zap")
local HelpGroup = Tabs["UI Settings"]:AddRightGroupbox(I18n:T("settings.help"), "circle-help")
...
local BalancedProfileButton = QuickActionsGroup:AddButton(I18n:T("settings.balanced"), function()
    Toggles.ReducedMotion:SetValue(false)
    Toggles.LiquidGlass:SetValue(true)
    Options.GlassTransparency:SetValue(0.28)
    Options.GlassPreset:SetValue("Liquid")
...
local PerformanceProfileButton = QuickActionsGroup:AddButton(I18n:T("settings.performance"), function()
    Toggles.ReducedMotion:SetValue(true)
    Toggles.LiquidGlass:SetValue(false)
    Toggles.GlassBlur:SetValue(false)
    Options.DPIDropdown:SetValue("100%")
end)
local HelpLabel = HelpGroup:AddLabel(I18n:T("settings.help_text"), true)
HelpGroup:AddDivider()
local CreditsGroup = Tabs.Credits:AddLeftGroupbox(I18n:T("credits.group"), "badge-check")
local MadeByLabel = CreditsGroup:AddLabel(I18n:T("settings.made_by"), true)
local DiscordCreditLabel = CreditsGroup:AddLabel(I18n:T("settings.discord_credit"), true)


local LocalizedSettingsElements = {
    { Tabs.Key, "tabs.key" },
    { Tabs["UI Settings"], "tabs.settings" },
    { Tabs.Credits, "tabs.credits" },
    { CreditsGroup, "credits.group" },
    ...
    { QuickActionsGroup, "settings.quick_actions" },
    { HelpGroup, "settings.help" },
    ...
    { BalancedProfileButton, "settings.balanced" },
    { PerformanceProfileButton, "settings.performance" },
    { HelpLabel, "settings.help_text" },
    { MadeByLabel, "settings.made_by" },
    { DiscordCreditLabel, "settings.discord_credit" },
