...
local Player = loadstring(game:HttpGet(repo .. "addons/Player.lua"))()
local WeaponMods = loadstring(game:HttpGet(repo .. "addons/WeaponMods.lua"))()
...
local function SetupESP()
    ...
    local ESPGroup = Tabs.Combat:AddRightGroupbox("ESP & Aimbot", "eye")
