...
local ESP = loadstring(game:HttpGet(repo .. "addons/ESP.lua"))()
local Radar = loadstring(game:HttpGet(repo .. "addons/Radar.lua"))()
local Movement = loadstring(game:HttpGet(repo .. "addons/Movement.lua"))()
local Visuals = loadstring(game:HttpGet(repo .. "addons/Visuals.lua"))()
local Camera = loadstring(game:HttpGet(repo .. "addons/Camera.lua"))()
local Protections = loadstring(game:HttpGet(repo .. "addons/Protections.lua"))()
local ServerInfo = loadstring(game:HttpGet(repo .. "addons/ServerInfo.lua"))()
local QoL = loadstring(game:HttpGet(repo .. "addons/QoL.lua"))()
local UIUtilities = loadstring(game:HttpGet(repo .. "addons/UIUtilities.lua"))()
...
-- Show the access tab first. Main and UI Settings become available only after verification.
...
VisGroup:AddSlider("NightVisionIntensity", {
    ...
    Suffix = "%",
    Callback = function(Value)
        VisualsManager:SetNightVision(Toggles.NightVisionToggle and Toggles.NightVisionToggle.Value or false, Value / 100)
    end,
})
...
VisGroup:AddToggle("FogOverrideToggle", {
    ...
    Callback = function(Value)
        if Value then
            VisualsManager:SetFogOverride(true, Options.FogStartSlider.Value, Options.FogEndSlider.Value)
        else
...
CamGroup:AddSlider("ThirdPersonDistance", {
    ...
    Suffix = " studs",
    Callback = function(Value)
        CameraManager:SetThirdPerson(Toggles.ThirdPersonToggle and Toggles.ThirdPersonToggle.Value or false, Value)
    end,
})
...
CamGroup:AddSlider("CameraSpinSpeed", {
    ...
    Suffix = "\u00B0/s",
    Callback = function(Value)
        CameraManager:SetSpin(Toggles.CameraSpinToggle and Toggles.CameraSpinToggle.Value or false, Value)
    end,
})
...
ProtGroup:AddToggle("AntiKickToggle", {
    ...
    Callback = function(Value)
        ProtectionManager:SetAntiKick(Value, Toggles.AntiKickRejoinToggle and Toggles.AntiKickRejoinToggle.Value or false)
    end,
})
...
ProtGroup:AddSlider("AntiIdleInterval", {
    ...
    Suffix = "s",
    Callback = function(Value)
        ProtectionManager:SetAntiIdle(Toggles.AntiIdleToggle and Toggles.AntiIdleToggle.Value or false, Value)
    end,
})
