...
local Credits = loadstring(game:HttpGet(repo .. "addons/Credits.lua"))()
...
local CreditsAddon = Credits.new(Library, {
    Title = I18n:T("credits.group"),
    Author = I18n:T("settings.made_by"),
    Discord = "https://discord.gg/3TdxfzrYwf",
})
local CreditsGroup = CreditsAddon:Attach(Tabs.Credits)
