...
function Library:CreateWindow(WindowInfo)
    ...
    WindowInfo.GlassTransparency = math.clamp(tonumber(WindowInfo.GlassTransparency) or 0.16, 0, 0.85)
    WindowInfo.GlassStrokeTransparency = math.clamp(tonumber(WindowInfo.GlassStrokeTransparency) or 0.25, 0, 1)
