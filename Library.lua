...
function Library:CreateWindow(WindowInfo)
    ...
    function Window:AddHeaderButton(
        ...
        local Connection = Library:GiveSignal(Button.MouseButton1Click:Connect(function()
    ...
    if Library.IsMobile then
        ...
        if WindowInfo.MobileButtonsSide == "Right" then
            ...
            MobileControlButton.Button.Position = UDim2.new(1, -6, 0, 6)
        else
            MobileControlButton.Button.AnchorPoint = Vector2.new(0, 0)
            MobileControlButton.Button.Position = UDim2.fromOffset(6, 6)
        end
