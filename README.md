...
**Current package version:** `26.7.4`
**License:** [MIT](LICENSE)
...
- `Window:Open()`, `Window:Close()`, `Window:SelectTab(name)`, `Window:GetActiveTab()`, `Window:ToggleSidebar()`, and `Window:ResetPosition()` support menu navigation and layout controls.
