...
**Current package version:** `26.7.5`
**License:** [MIT](LICENSE)
...
The example menu exposes **Liquid Glass**, **Glass Transparency**, **Glass Preset**, **Animate Glass**, and optional **Glass Blur** controls under UI Settings.
