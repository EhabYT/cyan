...
local function CloneLightingProperties(LightingInstance: Lighting): { [string]: any }
	local Props = {}
	for _, Property in { "Ambient", "Brightness", "ColorShift_Top", "ColorShift_Bottom", "OutdoorAmbient",
		"FogStart", "FogEnd", "FogColor", "GlobalShadows", "ClockTime", "GeographicLatitude",
		"ExposureCompensation", "EnvironmentDiffuseScale", "EnvironmentSpecularScale" } do
