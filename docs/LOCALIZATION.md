...
The bundled example includes **English**, **Deutsch**, **Français**, **Español**, **Português**, **Italiano**, **Русский**, **Türkçe**, **فارسی**, **اردو**, and **العربية**. These language packs are selectable before login as well as from UI Settings. Persian and Urdu automatically use RTL login alignment. Application-specific persistence strings that are not supplied by a locale safely use the default English dictionary.
