...
def main() -> None:
    ...
    if package.get("version") != "26.7.23":
        fail("wally package version must be 26.7.23")
    ...
    for source_fragment in ("CornerRadius = 12", "ClipsDescendants = true", "CurrentMenu:Close(true)", "FrameAbsolutePosition"):
